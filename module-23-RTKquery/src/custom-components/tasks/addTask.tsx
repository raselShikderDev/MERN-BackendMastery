...
import { useCreateTaskMutation } from "@/redux/api/baseurl";
...
export function AddTaskModal() {
  ...
  const onsubmit = async (data: any) => {
    ...
    console.log("[debug from inside submit] - ", res);
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="rasel">rasel</SelectItem>
                          <SelectItem value="shikder">shikder</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
